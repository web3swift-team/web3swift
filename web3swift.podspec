Pod::Spec.new do |spec|
    ...
    spec.authors      = { "Alex Vlasov" => "alex.m.vlasov@gmail.com", "Anton Grigorev" => "antongrigorjev2010@gmail.com" }
    spec.source       = { :git => 'https://github.com/matter-labs/web3swift.git', :tag => spec.version }
    spec.source_files = "Sources/web3swift/{Transaction,Contract,Web3,Promises,HookedFunctions,KeystoreManager,Convenience,EthereumABI,EthereumAddress,SwiftRLP}/*.swift", "Sources/web3swift/Utils/**/*.swift", "Sources/web3swift/Tokens/**/*.swift"

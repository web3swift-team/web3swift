...
//    
//    // TODO: -DispatchQueue
//    public init(provider: _ObjCWeb3HttpProvider, queue: DispatchQueue, policy: _ObjCDispatchPolicy) {
...
//    }
//    
//    public struct _ObjCDispatchPolicy {
//        var value: UInt32 = 0
//        var batchValue: UInt32 = 0
//        public init(_ val: UInt32, batchVal: UInt32 = 0) {
//            value = val
//            if val != 0 {
//                batchValue = batchVal
//            }

...
//public final class _ObjCWeb3HttpProvider: NSObject{
//    private (set) var web3Provider: Web3HttpProvider?
//    
//    public init(providerURL: NSURL, network: _ObjCNetwork, keystoreManager: _ObjCKeystoreManager){
...
//    }
//    
//    public init(web3Provider: Web3HttpProvider) {
//        self.web3Provider = web3Provider
//    }
//}
//
//@objc(Network)
//public final class _ObjCNetwork: NSObject {

...
public struct EventParserV2 {
    public struct EventParsingResult {
        public var event: ABIv2.Element
        public var receipt: TransactionReceipt
        public var decodedResult: [String:Any]
    }
    ...
    public var filter: EventFilter?
    var web3: web3
    public init? (web3 web3Instance: web3, event: ABIv2.Element, contract: ContractProtocol, filter: EventFilter? = nil) {
        guard case .event(_) = event else {return nil}
        self.event = event
        self.web3 = web3Instance
        self.contract = contract

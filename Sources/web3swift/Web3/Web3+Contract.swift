...
extension web3 {
    ...
    public func contract(_ abiString: String, at: EthereumAddress? = nil, abiVersion: Int = 2) -> web3contract? {
        return try? web3contract(web3: self, abiString: abiString, at: at, transactionOptions: self.transactionOptions, abiVersion: abiVersion)
    }
    ...
    public class web3contract {
        ...
        public init(web3 web3Instance:web3, abiString: String, at: EthereumAddress? = nil, transactionOptions: TransactionOptions? = nil, abiVersion: Int = 2) throws {
        ...
        public func createEventParser(_ eventName:String, filter:EventFilter?) throws -> EventParserProtocol? {
            try EventParser(web3: self.web3, eventName: eventName, contract: self.contract, filter: filter)
        }
    }
}

...
public extension Web3 {
    ...
    static func new(_ providerURL: URL) async throws -> Web3 {
    ...
    static func InfuraMainnetWeb3(accessToken: String? = nil) async -> Web3 {
    ...
    static func InfuraRinkebyWeb3(accessToken: String? = nil) async -> Web3 {
    ...
    static func InfuraRopstenWeb3(accessToken: String? = nil) async -> Web3 {
    ...
    static func InfuraKovanWeb3(accessToken: String? = nil) async -> Web3 {

...
extension Web3 {
    ...
    public static func new(_ providerURL: URL, network net: Networks = .Mainnet) async throws -> Web3 {
        // FIXME: Change this hardcoded value to dynamicly fethed from a Node
        guard let provider = await Web3HttpProvider(providerURL, network: net) else {

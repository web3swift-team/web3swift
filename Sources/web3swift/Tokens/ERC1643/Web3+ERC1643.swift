...
public class ERC1643: IERC1643, ERC20BaseProperties {
    ...
    public func removeDocument(from: EthereumAddress, name: Data) throws -> WriteOperation {
        ...
        let tx = contract.createWriteOperation("removeDocument", parameters: [name] as [AnyObject], transactionOptions: basicOptions)!
        return tx
    }
    ...
    public func getAllDocuments() async throws -> [Data] {
        ...
        var transactionOptions = CodableTransaction.emptyTransaction
        transactionOptions.callOnBlock = .latest
        let result = try await contract.createReadOperation("getAllDocuments", parameters: [] as [AnyObject], extraData: Data(), transactionOptions: self.transactionOptions)!.decodedData()

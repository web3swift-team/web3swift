...
public final class GanacheProvider: Web3HttpProvider {
    public init?(_ net: Networks = Networks.Mainnet, keystoreManager manager: KeystoreManager? = nil) async {
...
extension Web3 {
    ...
    public static func GanacheWeb3(network: Networks = Networks.Mainnet) async -> web3 {
        let ganache = await GanacheProvider(network)!
...
class web3swiftGanacheTests: XCTestCase {
    ...
    func testGetBalance() async throws {
        do {
            let web3 = await Web3.GanacheWeb3()
    ...
    func testUserCaseEventParsing() async throws {
        ...
        let web3 = await Web3.GanacheWeb3(network: .Rinkeby)

...
class PersonalSignatureTests: LocalTestCase {
    ...
    func testPersonalSignature() throws {
        ...
        let signature = try ganache.personal.signPersonalMessage(message: message.data(using: .utf8)!, from: expectedAddress, password: "")
        ...
        let signer = try ganache.personal.ecrecover(personalMessage: message.data(using: .utf8)!, signature: signature)
    ...
    func testPersonalSignatureOnContract() throws {
        ...
        // Calling contract
        contract = ganache.contract(abiString, at: receipt.contractAddress!)!
